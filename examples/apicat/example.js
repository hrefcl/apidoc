 ...
 *
 * @apiDescription Compare version 3.0.0 with 2.0.0 and you will see the green markers with new items in version 3.0.0 and red markers with removed items since 2.0.0.
 *
 ...
 * const client = LexCorpApi('5f048fe');
 * const user = client.getUser(42);
 * @apiExample {python} Python example
 * client = LexCorpApi.Client(token="5f048fe")
 ...
 * @apiSuccess {Number} [opt]  profile.age   Users age.
 ...
 * @apiBody {String} name name=Caroline Name of the User
 * @apiBody {Object} extraInfo Date when user was hired
 * @apiBody {Date} extraInfo.hireDate Date when user was hired
 * @apiBody {Date} [extraInfo.hireDateWithDefault] Date when user was hired with default
