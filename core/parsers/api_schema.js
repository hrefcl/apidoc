 ...
 * @since 4.0.0
 */
function parseTypeScriptInterface(interfaceContent, interfaceName) {
    const elements = [];
 ...
 * @since 4.0.0
 */
function parseTypeScriptType(typeDefinition) {
...
function parseJsonSchema(schemaPath, relativeTo) {
    const elements = [];
    try {
        const fullPath = path_1.default.resolve(path_1.default.dirname(relativeTo), schemaPath);
        const schemaContent = fs_1.default.readFileSync(fullPath, 'utf8');
...
function processor(elements, element, block, filename) {
    ...
    if (parsed.schemaType === 'interface') {
        ...
        const interfaceDefinition = (0, typescript_parser_1.findInterface)(interfaceName, filename);
        if (interfaceDefinition) {
            newElements = (0, typescript_parser_1.interfaceToApiDocElements)(interfaceDefinition, parsed.element, parsed.group);
        }
        else {
...
//# sourceMappingURL=api_schema.js.map