...
function parse(content, source, messages) {
    ...
    if (matches[0] === '') {
        throw new parameter_error_1.ParameterError('No arguments found.', messages.common.element, messages.common.usage, messages.common.example);
    }
    if (matches[2] !== '') {
        throw new parameter_error_1.ParameterError('Name must contain only alphanumeric and colon characters.', messages.common.element, messages.common.usage, messages.common.example);
    }
...
//# sourceMappingURL=api_define.js.map