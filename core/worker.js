...
function Worker(_app) {
    ...
    workers.forEach(function (worker) {
        if (lodash_1.default.isObject(app.workers[worker])) {
 ...
 * Inherit
 */
util_1.default.inherits(Worker, Object);
/**
...
Worker.prototype.process = function (parsedFiles, parsedFilenames, packageInfos) {
    ...
    lodash_1.default.each(this.workers, function (worker, name) {
        if (worker.preProcess) {
            ...
            lodash_1.default.extend(preProcessResults, result);
        }
    });
    lodash_1.default.each(this.workers, function (worker, name) {
