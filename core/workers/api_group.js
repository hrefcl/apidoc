        ...
        parsedFile.forEach(function (block) {
            ...
            if (Object.keys(block.global).length === 0) {
                ...
                if (!group) {
                    ...
                    group = path_1.default.resolve(filenames[parsedFileIndex]);
                }
                ...
                if (preProcess[source][name][version]) {
                    ...
                    if (foundIndex === -1) {
                        ...
                        throw new worker_error_1.WorkerError('Referenced definition has no matching or a higher version. ' +
                            'Check version number in referenced define block.', filenames[parsedFileIndex], block.index, messages.common.element, messages.common.usage, messages.common.example, extra);
                    }
