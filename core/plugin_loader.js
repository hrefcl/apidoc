...
function PluginLoader(_app) {
    ...
    this.detectPugins(path_1.default.join(process.cwd(), '/node_modules'));
 ...
 * Inherit
 */
util_1.default.inherits(PluginLoader, Object);
/**
...
PluginLoader.prototype.detectPugins = function (dir) {
    ...
    let plugins;
    try {
        plugins = (0, glob_1.globSync)(dir + '/apidoc-plugin-*').concat((0, glob_1.globSync)(dir + '/@*/apidoc-plugin-*'));
    }
    catch (e) {
        app.log.warn(e);
        return;
    ...
    plugins.forEach(function (plugin) {
        ...
        const filename = path_1.default.relative(__dirname, plugin);
...
PluginLoader.prototype.loadPlugins = function () {
    lodash_1.default.forEach(this.plugins, function (filename, name) {
