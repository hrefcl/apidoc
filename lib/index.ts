...
import { ApiDocOptions, ApiDocParseResult, AppContext, LoggerInterface, MarkdownParser } from '../src/types';
 ...
 * @public
 */
function createDoc(options: ApiDocOptions): ApiDocParseResult | boolean {
    // process options
    try {
