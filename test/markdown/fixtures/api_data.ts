define({ "api": [
  ...
  },
  {
    ...
    "description": "Custom Markdown Parser: Compare version 3.0.0 with 2.0.0 and you will see the green markers with new items in version 3.0.0 and red markers with removed items since 2.0.0.",
    "header": {
      "fields": {
        "Header": [
          {
  ...
  },
  {
    ...
    "permission": [
      {
        "name": "admin",
        "title": "This title is visible in version 1.0.0 and 2.0.0",
        "description": ""
      }
    ],
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "UserNotFound",
            "description": "Custom Markdown Parser: The error description text in version 1.0.0."
          }
        ]
      }
    },
